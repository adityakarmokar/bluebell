    ...
    "undefined" != typeof $ &&
        $(function () {
            ...
            var t,
                ...
                o = $(".search-input"),
                l = $(".content-backdrop"),
                r = $("#search_result-wrapper"),
                sr = document.querySelector(".search-results");
            s.length &&
                s.on("click", function () {
                    n.length && (n.toggleClass("d-none"), o.focus(), r.toggleClass("d-none"));
                }),
                $(document).on("keydown", function (e) {
                    var t = e.ctrlKey,
                        e = 191 === e.which;
                    t && e && n.length && (n.toggleClass("d-none"), o.focus(), r.toggleClass("d-none"));
                }),
                setTimeout(function () {
