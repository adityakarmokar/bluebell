                ...
                },
                {
                    ...
                    render: function (t, e, s, a) {
                        ...
                        return (
                            ...
                            (c
                                ? '<img src="' + assetsPath + "img/ecommerce-images/" + c + '" alt="Product-' + i + '" class="rounded-2">'
                                : '<span class="avatar-initial rounded-2 bg-label-' +
                                  ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] +
                                  '">' +
                                  (c = (((c = (n = s.product_brand).match(/\b\w/g) || []).shift() || "") + (c.pop() || "")).toUpperCase()) +
                                  "</span>") +
