                                                ...
                                                { target: "Array", proto: !0, forced: !c },
                                                {
                                                    splice: function (e, t) {
                                                        var n,
                                                            ...
                                                            m = i(e, g),
                                                            b = arguments.length;
                                                        if ((0 === b ? (n = r = 0) : 1 === b ? ((n = 0), (r = g - m)) : ((n = b - 2), (r = p(f(o(t), 0), g - m))), g + n - r > 9007199254740991))
                                            ...
                                            addedfile: function (e) {
                                                ...
                                                if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer && !this.options.disablePreviews)) {
                                                    ...
                                                    this.options.addRemoveLinks &&
                                                        ((e._removeLink = m.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>"))),
                                            ...
                                            function o(e, t) {
                                                ...
                                                return (
                                                    ...
                                                    !1 !== n.options.previewsContainer &&
                                                        (n.options.previewsContainer ? (n.previewsContainer = o.getElement(n.options.previewsContainer, "previewsContainer")) : (n.previewsContainer = n.element)),
                                                            ...
                                                            value: function () {
                                                                ...
                                                                return (
                                                                    "FORM" !== this.element.tagName
                                                                        ? (t = o.createElement('<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'))).appendChild(r)
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            value: function (e) {
                                                                if (e.status === o.UPLOADING) {
                                                                    ...
                                                                    (e.status !== o.ADDED && e.status !== o.QUEUED) || ((e.status = o.CANCELED), this.emit("canceled", e), this.options.uploadMultiple && this.emit("canceledmultiple", [e]));
