...
<div class="card mb-4">
  <h5 class="card-header">Update Terms & Conditions</h5>
  <form class="card-body" method="POST" action="{{url('update-terms-conditions')}}">
    @csrf
    <div class="row g-3">
