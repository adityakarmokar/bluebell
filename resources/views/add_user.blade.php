...
@section('description', 'Add New User Details')
@section('keywords', 'Homepage description')
...
<div class="card mb-4">
    ...
    <form class="card-body" id="user_form" method="POST" action="" enctype="multipart/form-data">
      @csrf
      {{-- <div class="col-12">
          <div class="card mb-4">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="pan_no" id="pan_no" class="form-control" placeholder="AB367JK12" value="{{ $inputType == 'pan' ? $inputValue : old('pan_no') }}" required />
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="dob" id="dob1" class="form-control" placeholder="DD/MM-YYYY" value="{{ old('dob')}}" required />
          @error('dob')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="adhar_number" id="adhar_number" class="form-control" placeholder="12XX23XX45XX56" value="{{ old('adhar_number')}}" required />
        ...
        <div class="col-md-4">
          <label class="form-label" for="name">First</label>
          <input type="text" name="f_fname" id="f_fname" class="form-control" value="{{ old('f_fname')}}" />
          @error('f_fname')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          <label class="form-label" for="name">Mid</label>
          <input type="text" name="f_mname" id="f_mname" class="form-control" value="{{ old('f_mname')}}" />
          @error('f_mname')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-3">
          <label class="form-label" for="name">Last</label>
          <input type="text" name="f_lname" id="f_lname" class="form-control" value="{{ old('f_lname')}}" required />
          @error('f_lname')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <div class="input-group">   
            ...
            <input type="number" name="phone" id="phone" class="form-control" value="{{ $inputType == 'phone' ? $inputValue : old('phone') }}" required  />            
          </div>
        ...
        <div class="col-md-4">
          ...
          <div class="input-group">            
            <span class="input-group-text">IN (+91)</span>
            <input type="number" name="mobile" id="mobile" class="form-control" value="{{ $inputType == 'mobile' ? $inputValue : old('mobile') }}"  />
          </div>
          @error('mobile')
          <span style="color: red">{{ $message }}</span>
          @enderror
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="house_no" id="house_no" class="form-control" placeholder="" value="{{ old('house_no')}}" />
          @error('house_no')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="house_name" id="house_name" class="form-control" placeholder="" value="{{ old('house_name')}}" />
          @error('house_name')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="street" id="street" class="form-control" placeholder="" value="{{ old('street')}}" />
          @error('street')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="area" id="area" class="form-control" placeholder="" value="{{ old('area')}}" />
          @error('area')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="city" id="city" class="form-control" placeholder="" value="{{ old('city')}}" required />
          @error('city')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="state" id="state" class="form-control" placeholder="" value="{{ old('state')}}" required />
          @error('state')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="country" id="country" class="form-control" placeholder="" value="{{ old('country')}}" required />
          @error('country')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="pin_code" id="pin_code" class="form-control" placeholder="" value="{{ old('pin_code')}}" required />
          @error('pin_code')
          <span style="color: red">{{ $message }}</span>
          @enderror
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="d-flex kcustom-align-center">
            ...
            &nbsp;&nbsp;<input type="checkbox" name="office_check" id="office_check" value="1" /> &nbsp;&nbsp;&nbsp;
    ...
    <div id="office-div">
      ...
      <div class="row">
          <div class="col-md-4">
            <label class="form-label" for="house_no">HOUSE NO</label>
            <input type="text" name="office_house_no" id="office_house_no" class="form-control" placeholder="" value="{{ old('office_house_no')}}" />
          ...
          <div class="col-md-4">
            <label class="form-label" for="house_no">HOUSE NAME</label>
            <input type="text" name="office_house_name" id="office_house_name" class="form-control" placeholder="" value="{{ old('office_house_name')}}" />
          ...
          <div class="col-md-4">
            <label class="form-label" for="house_no">STREET</label>
            <input type="text" name="office_street" id="office_street" class="form-control" placeholder="" value="{{ old('office_street')}}" />
            @error('office_street')
            <span style="color: red">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="col-md-4">
            <label class="form-label" for="house_no">AREA</label>
            <input type="text" name="office_area" id="office_area" class="form-control" placeholder="" value="{{ old('office_area')}}" />
            @error('office_area')
            <span style="color: red">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="col-md-4">
            <label class="form-label" for="house_no">CITY</label>
            <input type="text" name="office_city" id="office_city" class="form-control" placeholder="" value="{{ old('office_city')}}" />
            @error('office_city')
            <span style="color: red">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="col-md-4">
            <label class="form-label" for="house_no">STATE</label>
            <input type="text" name="office_state" id="office_state" class="form-control" placeholder="" value="{{ old('office_state')}}" />
            @error('office_state')
            <span style="color: red">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="col-md-4">
            <label class="form-label" for="house_no">COUNTRY</label>
            <input type="text" name="office_country" id="office_country" class="form-control" placeholder="" value="{{ old('office_country')}}" />
          ...
          <div class="col-md-4">
            <label class="form-label" for="house_no">PIN CODE</label>
            <input type="text" name="office_pin_code" id="office_pin_code" class="form-control" placeholder="" value="{{ old('office_pin_code')}}" />
          ...
          <div class="row g-3">        
            <div class="col-md-6">
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" name="group-a[1][bank_name]" id="form-repeater-1-1" class="form-control" placeholder="e.g., HDFC" value="{{ old('bank_name')}}" required />
                </div>
                @error('bank_name')
                <span style="color: red">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-9">
              <div class="row mb-3">
                ...
                <div class="col-sm-6">            
                  <input type="text" name="group-a[1][branch]" id="form-repeater-1-1" class="form-control" placeholder="New Delhi" value="{{ old('branch')}}" required />
                </div>
                @error('branch')
                <span style="color: red">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-4">
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" name="group-a[1][ifsc]" id="form-repeater-1-1" class="form-control ifsc" placeholder="HDFC001" value="{{ old('ifsc')}}" required />
                  @error('ifsc')
                  <span style="color: red">{{ $message }}</span>
                  @enderror
                </div>
            ...
            <div class="col-md-6">
              <div class="row mb-3">
                ...
                <div class="col-sm-6">
                  <input type="text" name="group-a[1][re_ifsc]" id="form-repeater-1-1" class="form-control ifsc" placeholder="HDFC001" value="{{ old('re_ifsc')}}" required />
                  @error('re_ifsc')
                  <span style="color: red">{{ $message }}</span>
                  @enderror
                </div>
            ...
            <div class="col-md-6">
              <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <input type="text" name="group-a[1][account_no]" id="form-repeater-1-1" class="form-control" placeholder="12253XX438548XX" value="{{ old('account_no')}}" required />
                  @error('account_no')
                  <span style="color: red">{{ $message }}</span>
                  @enderror
                </div>
            ...
            <div class="col-md-6">
              <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <input type="text" name="group-a[1][re_account_no]" id="form-repeater-1-1" class="form-control" placeholder="12253XX438548XX" value="{{ old('re_account_no')}}" required />
                  @error('re_account_no')
                  <span style="color: red">{{ $message }}</span>
                  @enderror
                </div>
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="row mb-3">
            ...
            <div class="col-sm-7">
              <input type="text" name="income_tax_password" id="income_tax_password" class="form-control" placeholder="" value="{{ old('branch')}}" />
...
<script>
    $(document).ready(function(){
      ...
      $(document).on('keyup', '#pan_no', function(){
        var pan_no = $(this).val();
        var validation_span = $('#pan_no_validation');

        if(pan_no.length > 0){
          if(pan_no.length > 10 ){
            validation_span.css('color','red');
            validation_span.text("Pan length exceeded");
          }else{
            $.ajax({
                url: "{{route('user.validate_request')}}", 
                type: 'POST',
                data: {
                  _token: '{{csrf_token()}}',
                  pan_no: pan_no,
                ...
                success: function(response) {
                  ...
                  if(response.status == true){
                    validation_span.css('color','green');
                    validation_span.text(response.message);
          ...
          validation_span.text("");
        }
      });

      $(document).on('keyup', '#adhar_number', function(){
        var aadhar = $(this).val();
        var validation_span = $('#aadhar_validation');

        if(aadhar.length > 0){
          if(aadhar.length > 12 ){
            validation_span.css('color','red');
            validation_span.text("Aadhar length exceeded");
          }else{
            $.ajax({
                url: "{{route('user.validate_request')}}", 
                type: 'POST',
      ...
      $(document).on('focusout', '#phone', function(){
        ...
        var phone = $(this).val();
        var validation_span = $('#phoner_validation');

        if(phone.length > 0){
          if(phone.length > 14 ){
            validation_span.css('color','red');
            validation_span.text("Phone length exceeded");
          }else{
            $.ajax({
                url: "{{route('user.validate_request')}}", 
                type: 'POST',
