...
<div class="card mb-4">
  ...
  <form class="card-body" method="POST" action="{{url('update-about-us')}}">
    @csrf
    <div class="row g-3">
      ...
      <div class="form-repeater">
          ...
          <div data-repeater-list="group-a">
            @if (!empty($aboutUs->about_us))
              @foreach ($aboutUs->about_us as $item)
              <div data-repeater-item>
                  <div class="row">
                      <div class="mb-3 col-lg-12 mb-0 paratitle">
